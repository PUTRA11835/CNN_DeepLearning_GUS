...
model = load_model(r"D:\Semester 5\Kuliah\ML\Praktikum\CNN\Tugas6_A_11835\model_mobilenet.h5")
...
# Streamlit UI
st.title("Prediksi Kematangan Buah Naga - 1835")  # 4 digit npm terakhir
